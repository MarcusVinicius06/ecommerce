...
class User extends Model
{
  ...
  public static function validForgotDecrypt($code)
  {
    ...
    $results = $sql->select("SELECT * FROM db_ecommerce.tb_userspasswordsrecoveries a
  ...
  public static function setForgotUsed($idrecovery)
  {
    ...
    $result = $sql->query("UPDATE tb_userspasswordsrecoveries SET dtrecovery = NOW() WHERE idrecovery = :idrecovery", array(
      ":idrecovery" => $idrecovery
    ));
  }
